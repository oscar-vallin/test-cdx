...
describe('PageTitle', () => {
  ...
  it('Should render correctly', () => {
    const pageTitle = shallow(
      <Component id="__LeTitle" title="Page Title" subTitle="Sub Title" icon="FilterSolid"/>
    );
  ...
  it('Title Only', () => {
    const wrapper = shallow(
      <Component id="__PageTitle" title="Page Title Only"/>
    );
  ...
  it('Title and Icon', () => {
    const wrapper = shallow(
      <Component id="__PageTitle" title="Page Title" icon="FavoriteStar"/>
    );
  ...
  it('Title, Subtitle, and Icon', () => {
    const wrapper = shallow(
      <Component id="__PageTitle" title="Page Title" subTitle="SubSub" icon="FavoriteStar"/>
    );
    expect(wrapper.contains("Page Title")).toEqual(true);
